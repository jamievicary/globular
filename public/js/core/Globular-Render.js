...
function globular_render_2d(r, data, container, diagram, subdiagram) {
    ...
    for (var i = -1; i < data.edges.length; i++) {
        ...
        var path = r.finishPath({stroke_width: 0.01, stroke: 'none', fill: colour});
...
//             d.g.appendChild(path);
            ...
            r.finishPath({stroke: colour, stroke_width: 0.1, fill: 'none'});
        }
    }
...
//             }));
            ...
            r.finishPath({stroke: lower_colour, stroke_width: 0.1});
...
//             }));
            ...
            r.finishPath({stroke: upper_colour, stroke_width: 0.1});
...
function globular_add_highlight(r, data, box, boundary, diagram) {

    if (diagram.getDimension() < 2) return;
    var b = $(r.container)[0].bounds;
