...
Diagram.prototype.atomicInterchangerTarget = function(type, key_location) {
    ...
    if(this.cells.length != 0){
        if(this.cells[x].id.substr(0, 3) === 'Int'){
            ...
            var temp_coordinates_x = diff_array(this.cells[x].coordinates, heights.slice(0, heights.length - 1));
        }
    }
    ...
    if (type.tail('Int')) {
        ...
        if(x + 1 < this.cells.length){
            var temp_coordinates_x1 = diff_array(this.cells[x+1].coordinates, heights.slice(0, heights.length - 1));
        }
        ...
        if(temp_coordinates_x != null){
            ...
            this.cells[x].key.increment_last(-heights.penultimate() + g_target - g_source);
        }
        
        if(this.cells[x + 1].key != undefined){
            this.cells[x + 1].key.increment_last(-heights.penultimate());
        }
        
        list.push(new NCell(this.cells[x + 1].id, temp_coordinates_x1, this.cells[x + 1].key));
        list.push(new NCell(this.cells[x].id, temp_coordinates_x, this.cells[x].key));
    }
    ...
    if (type.tail('IntI')) {
        ...
        if(temp_coordinates_x != null){
            ...
            this.cells[x].key.increment_last(-heights.penultimate() + g_source - g_target);
        }
    ...
    if (type.tail('L')) {
        ...
        if(temp_coordinates_x != null){
            ...
            this.cells[x].key.increment_last(-heights.penultimate() + 1);
        }        
        list.push(new NCell(this.cells[x].id, temp_coordinates_x, this.cells[x].key));
    }
    ...
    if (type.tail('LI')) {
        ...
        list.splice(0, 0, new NCell(this.cells[x].id, temp_coordinates_x, this.cells[x].key));
    }
